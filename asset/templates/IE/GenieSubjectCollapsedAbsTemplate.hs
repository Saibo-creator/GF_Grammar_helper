abstract {abs_grammar_name} = {{
  ...
  cat
    Text ; BOG ; EOG ; Triplet ; Triplets ; Doublet ; Doublets ; Subject ; Relation; Object ; Triplet_ending_marker; Subject_marker ; Relation_marker; Object_marker ; Rel ; Entity ;
  fun
    Start: BOG -> Triplets -> EOG -> Text ;
    Repeat:  Triplet -> Triplets -> Triplets ;
    Empty_triplet: Triplet;
    Empty_triplets: Triplets;
    Derive_triplet : Subject -> Doublets -> Triplet_ending_marker -> Triplet ;
    Derive_triplets : Subject -> Doublets -> Triplet_ending_marker -> Triplets ;
