...
class CPCrtGrammarBuilder(TemplateTokenGrammarBuilder, ABC):
    template = os.path.join(TEMPLATE_DIR, "CP", "CP-PTB-CrtTemplate.hs")
...
if __name__ == '__main__':
    ...
    grammar = CPCrtGrammarBuilder(tokenizer_or_path="/Users/saibo/Research/llama_hf/7B",literal=False).build(base_grammar_name="CP-PTB",
