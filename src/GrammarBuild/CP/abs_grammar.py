...
class CPAbsGrammarBuilder(TemplateTokenGrammarBuilder):
    template = os.path.join(TEMPLATE_DIR, "CP", "CP-PTB-AbsTemplate.hs")
    grammar_prefix = ""
...
if __name__ == '__main__':
    ...
    grammar = CPAbsGrammarBuilder(tokenizer_or_path="/Users/saibo/Research/llama_hf/7B", literal=False)\
