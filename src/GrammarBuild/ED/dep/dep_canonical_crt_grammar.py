...
class ED_DepCanonicalCrtGrammarBuilder(ED_IndepMinimalCrtGrammarBuilder, ABC):
    ...
    template = os.path.join(TEMPLATE_DIR, "ED", "Dep", "canonical", "ED-Dep-Canonical-CrtTemplate.hs")
    grammar_prefix = ""
    ...
    def build(self, base_grammar_name: str, **kwargs) -> Grammar:
        ...
        formatted_grammar_plain_text: str = grammar.format(abs_grammar_name=abs_grammar_name, crt_grammar_name=crt_grammar_name,
                                                           ...
                                                           canonical_phrase_tokens=self.get_entity_tokens(self.Canonical_phrase_prompt,  rm_eos=True),
