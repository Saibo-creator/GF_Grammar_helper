...
class ED_DepCanonicalAbsGrammarBuilder(ED_IndepMinimalAbsGrammarBuilder):

    template = os.path.join(TEMPLATE_DIR, "ED", "Dep", "canonical", "ED-Dep-Canonical-AbsTemplate.hs")
    grammar_prefix = ""
