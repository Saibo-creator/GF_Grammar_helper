...
class ELotfeAbsGrammarBuilder(ELAbsGrammarBuilder):

    template = os.path.join(TEMPLATE_DIR, "EL", "EL-OTF-efficient-AbsTemplate.hs")
    grammar_prefix = ""
...
if __name__ == '__main__':
    grammar = ELotfeAbsGrammarBuilder(tokenizer_or_path="/Users/saibo/Research/llama_hf/7B", literal=True) \
        .build(base_grammar_name="EL-OTFE", num_mentions=2, entities_or_path=[["Q1", "Q2", "Q3", "Q4"], ["Q5", "Q6", "Q7", "Q8"]])
    grammar.save("./EL-OTF-efficient-AbsTemplate.hs")
