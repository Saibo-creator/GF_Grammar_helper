...
class ELotfsCrtGrammarBuilder(ELCrtGrammarBuilder, ABC):
    ...
    def build(self, base_grammar_name: str, entities_or_path: Union[List[str], str, List[List[str]]], crt_grammar_name=None,
              mention:str=None, left_context:str=None, right_context:str=None, **kwargs) -> Grammar:
