...
from src.config.config import GF_AUTO_GEN_GF_DIR,DATA_DIR,IE_DATA_PATH
...
if __name__ == '__main__':
    ...
    if args.debug:
        ...
        entities_path = IE_DATA_PATH["KB"][args.dataset]["entity"]
        relations_path = IE_DATA_PATH["KB"][args.dataset]["relation"]
